...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/navbar.vue?vue&type=template&id=e97bff00&scoped=true&
var navbarvue_type_template_id_e97bff00_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav',{staticClass:"bg-gray-800"},[_vm._ssrNode("<div class=\"max-w-7xl mx-auto px-2 sm:px-6 lg:px-8\" data-v-e97bff00><div class=\"relative flex items-center justify-between h-16\" data-v-e97bff00><div class=\"absolute inset-y-0 left-0 flex items-center sm:hidden\" data-v-e97bff00><button aria-label=\"Main menu\" aria-expanded=\"false\" class=\"inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out\" data-v-e97bff00><svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" class=\"block h-6 w-6\" data-v-e97bff00><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 6h16M4 12h16M4 18h16\" data-v-e97bff00></path></svg> <svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" class=\"hidden h-6 w-6\" data-v-e97bff00><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M6 18L18 6M6 6l12 12\" data-v-e97bff00></path></svg></button></div> <div class=\"flex-1 flex items-center justify-center sm:items-stretch sm:justify-start\" data-v-e97bff00><div class=\"flex-shrink-0\" data-v-e97bff00><h2 class=\"h-8\" data-v-e97bff00>\n            Nicholas Chen\n          </h2></div> <div class=\"hidden sm:block sm:ml-6\" data-v-e97bff00><div class=\"flex\" data-v-e97bff00><a href=\"#\" class=\"px-3 py-2 rounded-md text-sm font-medium leading-5 text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Dashboard</a> <a href=\"#\" class=\"ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Team</a> <a href=\"#\" class=\"ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Projects</a> <a href=\"#\" class=\"ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Calendar</a></div></div></div> <div class=\"absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0\" data-v-e97bff00><button aria-label=\"Notifications\" class=\"p-1 border-2 border-transparent text-gray-400 rounded-full hover:text-white focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00><svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\" class=\"h-6 w-6\" data-v-e97bff00><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9\" data-v-e97bff00></path></svg></button> <div class=\"ml-3 relative\" data-v-e97bff00><div data-v-e97bff00><button id=\"user-menu\" aria-label=\"User menu\" aria-haspopup=\"true\" class=\"flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-white transition duration-150 ease-in-out\" data-v-e97bff00><img src=\"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80\" alt class=\"h-8 w-8 rounded-full\" data-v-e97bff00></button></div> <div class=\"origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg\" data-v-e97bff00><div role=\"menu\" aria-orientation=\"vertical\" aria-labelledby=\"user-menu\" class=\"py-1 rounded-md bg-white shadow-xs\" data-v-e97bff00><a href=\"#\" role=\"menuitem\" class=\"block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out\" data-v-e97bff00>Your Profile</a> <a href=\"#\" role=\"menuitem\" class=\"block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out\" data-v-e97bff00>Settings</a> <a href=\"#\" role=\"menuitem\" class=\"block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out\" data-v-e97bff00>Sign out</a></div></div></div></div></div></div> <div class=\"hidden sm:hidden\""+(_vm._ssrStyle(null,null, { display: (_vm.isOpen) ? '' : 'none' }))+" data-v-e97bff00><div class=\"px-2 pt-2 pb-3\" data-v-e97bff00><a href=\"#\" class=\"block px-3 py-2 rounded-md text-base font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Dashboard</a> <a href=\"#\" class=\"mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Team</a> <a href=\"#\" class=\"mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Projects</a> <a href=\"#\" class=\"mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out\" data-v-e97bff00>Calendar</a></div></div>")])}
var navbarvue_type_template_id_e97bff00_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/navbar.vue?vue&type=template&id=e97bff00&scoped=true&
...
var navbar_component = Object(componentNormalizer["a" /* default */])(
  ...
  navbarvue_type_template_id_e97bff00_scoped_true_render,
  navbarvue_type_template_id_e97bff00_scoped_true_staticRenderFns,
  false,
  navbar_injectStyles,
  "e97bff00",
  "1d795c88"
